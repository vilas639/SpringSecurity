...
//          .authorizeRequests(request -> request.anyRequest().permitAll())  //permit all 
        ...
        .sessionManagement(scm -> scm.invalidSessionUrl("/invaliuser").maximumSessions(1).maxSessionsPreventsLogin(true))  //prevent the concuurent login    //after session timeout redirect url
